...
const translations = {
  ...
  'home.subtitle': { en: 'Blockchain & UAV Researcher | Computer Science Student at NJUPT', zh: '区块链与无人机研究员 | NJUPT计算机科学学生', hi: 'ब्लॉकचेन और UAV शोधकर्ता | NJUPT में कंप्यूटर विज्ञान छात्र', es: 'Investigador en Blockchain y UAV | Estudiante de Ciencias de la Computación en NJUPT', fr: 'Chercheur en Blockchain et UAV | Étudiant en informatique à la NJUPT', ar: 'باحث في البلوكتشين والطائرات المسيّرة | طالب علوم الحاسب في NJUPT', bn: 'ব্লকচেইন ও UAV গবেষক | NJUPT-এ কম্পিউটার বিজ্ঞান শিক্ষার্থী', pt: 'Pesquisador em Blockchain e UAV | Estudante de Ciência da Computação na NJUPT', ru: 'Исследователь блокчейна и БПЛА | Студент компьютерных наук в NJUPT', ja: 'ブロックチェーン・UAV研究者 | NJUPTのコンピュータサイエンス学生' },
  'home.description': { en: 'Driving innovations in secure next-generation aerial networks at NJUPT. My work leverages Proof-of-History blockchain architectures, smart contracts, and high-fidelity AirSim environments to solve critical authentication and spectrum security challenges in UAV swarms.', zh: 'NJUPT计算机科学与技术研究员，专注于区块链赋能无人机系统、安全频谱管理及下一代空中网络的去中心化解决方案。', hi: 'NJUPT में कंप्यूटर विज्ञान एवं प्रौद्योगिकी शोधकर्ता, ब्लॉकचेन-सक्षम UAV प्रणाली, सुरक्षित स्पेक्ट्रम प्रबंधन और अगली पीढ़ी के नेटवर्क में विशेषज्ञ।', es: 'Investigador en Ciencias de la Computación en NJUPT, especializado en sistemas UAV habilitados por blockchain, gestión segura del espectro y soluciones descentralizadas para redes aéreas de próxima generación.', fr: "Chercheur en Sciences Informatiques à l'NJUPT, spécialisé dans les systèmes UAV basés sur la blockchain, la gestion sécurisée du spectre et les solutions décentralisées pour les réseaux aériens de prochaine génération.", ar: 'باحث في علوم الحاسب في NJUPT، متخصص في أنظمة الطائرات المسيّرة المدعومة بالبلوكتشين وإدارة الطيف الآمن والحلول اللامركزية للشبكات الجوية من الجيل القادم.', bn: 'NJUPT-এ কম্পিউটার বিজ্ঞান গবেষক, ব্লকচেইন-সক্ষম UAV সিস্টেম, নিরাপদ স্পেকট্রাম ব্যবস্থাপনা এবং পরবর্তী প্রজন্মের নেটওয়ার্কের জন্য বিকেন্দ্রীভূত সমাধানে বিশেষজ্ঞ।', pt: 'Pesquisador em Ciência da Computação na NJUPT, especializado em sistemas UAV baseados em blockchain, gestão segura de espectro e soluções descentralizadas para redes aéreas de próxima geração.', ru: 'Исследователь в области компьютерных наук в NJUPT, специализирующийся на системах БПЛА на основе блокчейна, безопасном управлении спектром и децентрализованных решениях для воздушных сетей нового поколения.', ja: 'NJUPTのコンピュータサイエンス研究者。ブロックチェーン対応UAVシステム、安全なスペクトル管理、次世代航空ネットワークの分散型ソリューションを専門とする。' },
  ...
  'about.leadership': { en: 'Leadership', zh: '领导力', hi: 'नेतृत्व', es: 'Liderazgo', fr: 'Leadership', ar: 'القيادة', bn: 'নেতৃত্ব', pt: 'Liderança', ru: 'Лидерство', ja: 'リーダーシップ' },
  'about.leadershipDetail': { en: 'President, ISU at NJUPT', zh: 'NJUPT 国际学生联盟（ISU）主席', hi: 'NJUPT में ISU अध्यक्ष', es: 'Presidente de ISU en NJUPT', fr: 'Président de l’ISU à la NJUPT', ar: 'رئيس اتحاد الطلاب الدوليين (ISU) في NJUPT', bn: 'NJUPT-এ ISU সভাপতি', pt: 'Presidente da ISU na NJUPT', ru: 'Президент ISU в NJUPT', ja: 'NJUPTのISU会長' },
  'about.leadershipSub': { en: 'Managing student events, campus activities, and cross-cultural communication.', zh: '负责学生活动、校园事务以及跨文化沟通。', hi: 'छात्र कार्यक्रमों, कैंपस गतिविधियों और अंतर-सांस्कृतिक संचार का प्रबंधन।', es: 'Gestión de eventos estudiantiles, actividades del campus y comunicación intercultural.', fr: 'Gestion des événements étudiants, des activités du campus et de la communication interculturelle.', ar: 'إدارة فعاليات الطلاب وأنشطة الحرم الجامعي والتواصل بين الثقافات.', bn: 'শিক্ষার্থী ইভেন্ট, ক্যাম্পাস কার্যক্রম এবং আন্তঃসাংস্কৃতিক যোগাযোগ পরিচালনা।', pt: 'Gestão de eventos estudantis, atividades no campus e comunicação intercultural.', ru: 'Организация студенческих мероприятий, кампусной активности и межкультурной коммуникации.', ja: '学生イベント、キャンパス活動、異文化コミュニケーションを運営。' },
  'about.languageProficiency': { en: 'Language Proficiency', zh: '语言能力', hi: 'भाषा दक्षता', es: 'Competencia Lingüística', fr: 'Compétence linguistique', ar: 'الكفاءة اللغوية', bn: 'ভাষাগত দক্ষতা', pt: 'Proficiência em Idiomas', ru: 'Языковая компетенция', ja: '語学力' },
  'about.languageDetail': { en: 'Chinese (HSK 4)', zh: '中文（HSK 4）', hi: 'चीनी (HSK 4)', es: 'Chino (HSK 4)', fr: 'Chinois (HSK 4)', ar: 'الصينية (HSK 4)', bn: 'চীনা (HSK 4)', pt: 'Chinês (HSK 4)', ru: 'Китайский (HSK 4)', ja: '中国語（HSK 4）' },
  'about.languageSub': { en: 'Achieved HSK 4 Chinese Language Proficiency certification.', zh: '已获得汉语水平考试 HSK 4 级证书。', hi: 'HSK 4 चीनी भाषा दक्षता प्रमाणन प्राप्त किया।', es: 'Certificación HSK 4 de competencia en idioma chino obtenida.', fr: 'Certification HSK 4 de compétence en langue chinoise obtenue.', ar: 'حصلت على شهادة الكفاءة اللغوية الصينية HSK 4.', bn: 'HSK 4 চাইনিজ ভাষা দক্ষতা সনদ অর্জিত।', pt: 'Certificação de proficiência em chinês HSK 4 obtida.', ru: 'Получен сертификат HSK 4 по китайскому языку.', ja: '中国語能力認定 HSK 4 を取得。' },
  ...
  'skill.hsk4certified': { en: 'Achieved HSK 4 Chinese Language Proficiency certification', zh: '已获得汉语水平考试 HSK 4 级证书', hi: 'HSK 4 चीनी भाषा दक्षता प्रमाणन प्राप्त किया', es: 'Certificación HSK 4 de competencia en idioma chino obtenida', fr: 'Certification HSK 4 de compétence en langue chinoise obtenue', ar: 'حصلت على شهادة الكفاءة اللغوية الصينية HSK 4', bn: 'HSK 4 চাইনিজ ভাষা দক্ষতা সনদ অর্জিত', pt: 'Certificação de proficiência em chinês HSK 4 obtida', ru: 'Получен сертификат HSK 4 по китайскому языку', ja: '中国語能力認定 HSK 4 を取得' },
  ...
  'blog.myBlog': { en: 'My Blog', zh: '我的博客', hi: 'मेरा ब्लॉग', es: 'Mi Blog', fr: 'Mon Blog', ar: 'مدونتي', bn: 'আমার ব্লগ', pt: 'Meu Blog', ru: 'Мой Блог', ja: '私のブログ' },
  'blog.researchAndInsights': { en: 'Research & Insights', zh: '研究与见解', hi: 'अनुसंधान और अंतर्दृष्टि', es: 'Investigación e Ideas', fr: 'Recherche & Perspectives', ar: 'البحث والرؤى', bn: 'গবেষণা ও অন্তর্দৃষ্টি', pt: 'Pesquisa & Insights', ru: 'Исследования и Идеи', ja: '研究とインサイト' },
  'blog.intro': { en: 'Exploring blockchain technology, UAV systems, smart contracts, and decentralized solutions. Follow my research journey and technical insights.', zh: '探索区块链技术、无人机系统、智能合约和去中心化解决方案。跟随我的研究之旅和技术见解。', hi: 'ब्लॉकचेन तकनीक, UAV सिस्टम, स्मार्ट कॉन्ट्रैक्ट और विकेन्द्रीकृत समाधानों की खोज। मेरी शोध यात्रा और तकनीकी अंतर्दृष्टि का अनुसरण करें।', es: 'Explorando tecnología blockchain, sistemas UAV, contratos inteligentes y soluciones descentralizadas. Sigue mi trayectoria de investigación e ideas técnicas.', fr: 'Explorer la technologie blockchain, les systèmes UAV, les contrats intelligents et les solutions décentralisées. Suivez mon parcours de recherche et mes insights techniques.', ar: 'استكشاف تقنية البلوكتشين وأنظمة الطائرات المسيّرة والعقود الذكية والحلول اللامركزية. تابع رحلتي البحثية ورؤاي التقنية.', bn: 'ব্লকচেইন প্রযুক্তি, UAV সিস্টেম, স্মার্ট কন্ট্র্যাক্ট এবং বিকেন্দ্রীভূত সমাধান অন্বেষণ করছি। আমার গবেষণা যাত্রা এবং প্রযুক্তিগত অন্তর্দৃষ্টি অনুসরণ করুন।', pt: 'Explorando tecnologia blockchain, sistemas UAV, contratos inteligentes e soluções descentralizadas. Siga minha jornada de pesquisa e insights técnicos.', ru: 'Исследование технологии блокчейн, систем БПЛА, смарт-контрактов и децентрализованных решений. Следите за моим исследовательским путём и техническими идеями.', ja: 'ブロックチェーン技術、UAVシステム、スマートコントラクト、分散型ソリューションを探求しています。私の研究の旅と技術的インサイトをフォローしてください。' },

  // 404 PAGE
  'page404.pageNotFound': { en: 'Page Not Found', zh: '页面未找到', hi: 'पृष्ठ नहीं मिला', es: 'Página No Encontrada', fr: 'Page Non Trouvée', ar: 'الصفحة غير موجودة', bn: 'পৃষ্ঠা পাওয়া যায়নি', pt: 'Página Não Encontrada', ru: 'Страница Не Найдена', ja: 'ページが見つかりません' },
  'page404.message': { en: "Oops! The page you're looking for doesn't exist or has been moved. Let's get you back on track.", zh: '哎呀！您要找的页面不存在或已移动。让我们帮您找到正确方向。', hi: 'अरे! आप जिस पृष्ठ को खोज रहे हैं वह मौजूद नहीं है या स्थानांतरित हो गया है। आपको वापस सही रास्ते पर लाते हैं।', es: '¡Vaya! La página que buscas no existe o ha sido movida. Volvamos a encaminarte.', fr: 'Oups ! La page que vous recherchez n\'existe pas ou a été déplacée. Remettons-vous sur la bonne voie.', ar: 'عذراً! الصفحة التي تبحث عنها غير موجودة أو تم نقلها. دعنا نعيدك إلى المسار الصحيح.', bn: 'ওহো! আপনি যে পৃষ্ঠাটি খুঁজছেন সেটি বিদ্যমান নেই বা সরানো হয়েছে। আপনাকে সঠিক পথে ফিরিয়ে আনি।', pt: 'Ops! A página que você está procurando não existe ou foi movida. Vamos te colocar de volta nos trilhos.', ru: 'Упс! Страница, которую вы ищете, не существует или была перемещена. Давайте вернём вас на правильный путь.', ja: 'おっと！お探しのページは存在しないか、移動されました。正しいページに案内します。' },
  'page404.goHome': { en: 'Go Home', zh: '返回首页', hi: 'होम पर जाएं', es: 'Ir al Inicio', fr: 'Aller à l\'accueil', ar: 'الذهاب للرئيسية', bn: 'হোমে যান', pt: 'Ir para Home', ru: 'На Главную', ja: 'ホームへ' },
  'page404.viewProjects': { en: 'View Projects', zh: '查看项目', hi: 'परियोजनाएं देखें', es: 'Ver Proyectos', fr: 'Voir les Projets', ar: 'عرض المشاريع', bn: 'প্রকল্প দেখুন', pt: 'Ver Projetos', ru: 'Смотреть Проекты', ja: 'プロジェクトを見る' },
};
